...
return array (
  ...
  array (
    ...
    'Yes' => '是',
    'No' => '否',
    'Demo products are a good way to learn how to use eCartx. You should install them if you are not familiar with it.' => '演示商品是个了解如何使用 eCartx 好方法。如果您还不熟悉如何在 eCartx 上开店，您应该安装它们。',
    'Country' => '国家',
    ...
    'Documentation' => '文档',
    'Contact us' => '联系我们',
    'eCartx Installation Assistant' => 'eCartx 安装助手',
    'Forum' => '论坛',
    'Blog' => '博客',
    'Contact us!' => '联系我们！',
    'menu_welcome' => '请选择语言',
    ...
    'To install eCartx, you need to have JavaScript enabled in your browser.' => '您需要在浏览器中启用 JavaScript 来安装 eCartx。',
    'http://doc.eCartx.com/display/PS16/What+you+need+to+get+started#HowtoenableJavaScript-HowtoenableJavaScript' => 'http://doc.eCartx.com/display/PS16/What+you+need+to+get+started#HowtoenableJavaScript-HowtoenableJavaScript',
    'License Agreements' => '许可协议',
    'To enjoy the many features that are offered for free by eCartx, please read the license terms below. eCartx core is licensed under OSL 3.0, while the modules and themes are licensed under AFL 3.0.' => '想要享受 eCartx 提供的多种免费功能，请阅读下面的许可条款。eCartx 核心是以 OSL 3.0协议 授权，但是模块和主题授权于 AFL3.0 协议。',
    ...
    'You have just finished installing your shop. Thank you for using eCartx!' => '您已完成店铺的安装。感谢您使用 eCartx！',
    ...
    'I just built an online store with eCartx!' => '我刚刚在eCartx开了一家网上商店！',
    ...
    'Pinterest' => 'Pinterest',
    'LinkedIn' => 'LinkedIn',
    'Check out eCartx Addons to add the little something extra to your store!' => '在 eCartx Addons 寻找或更新您的网店需要的一些小插件！',
    'We are currently checking eCartx compatibility with your system environment' => '我们正在检查您和 eCartx 的系统环境兼容',
    ...
    'eCartx compatibility with your system environment has been verified!' => '您和 eCartx 的系统环境兼容已通过验证！',
    ...
    'eCartx requires at least 32 MB of memory to run: please check the memory_limit directive in your php.ini file or contact your host provider about this.' => 'eCartx 至少需要32M的内存来运行，请检查php.ini中的memory_limit的指令或联系您的主机提供商',
    '<b>Warning: You cannot use this tool to upgrade your store anymore.</b><br /><br />You already have <b>eCartx version %1$s installed</b>.<br /><br />If you want to upgrade to the latest version, please read our documentation: <a href="%2$s">%2$s</a>' => '<b>警告：你无法使用此工具来升级你的店铺。</b><br /><br />您已经安装了 <b> eCartx 的 %1$s s版本</b>。<br/><br/>如果你想升级到最新版本，请阅读我们的文档：<a href="%2$s">%2$s</a>',
    'Welcome to the eCartx %s Installer' => '欢迎来到eCartx %s 安装',
    'Installing eCartx is quick and easy. In just a few moments, you will become part of a community consisting of more than 185,000 merchants. You are on the way to creating your own unique online store that you can manage easily every day.' => 'eCartX 的安装快速而简单。在短短的几分钟，你就会成为一个拥有超过185,000位商人社区的一份子。在创建您独特的网上商店途中，您可以很容易地每天管理它。',
