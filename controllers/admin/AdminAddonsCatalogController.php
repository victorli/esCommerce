...
class AdminAddonsCatalogControllerCore extends AdminController
{
	...
	public function initContent()
	{
		...
		$addons_url = 'http://'._ECX_WEB_ADDON_.'/iframe/search-1.6.php?psVersion='._PS_VERSION_.'&isoLang='.$iso_lang.'&isoCurrency='.$iso_currency.'&isoCountry='.$iso_country.'&parentUrl='.$parent_domain;
